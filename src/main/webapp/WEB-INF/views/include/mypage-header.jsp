...
<body>
	<header class="header-area navbar-fade" id="header">
		<nav id="navbar">
			...
			<div id="brand-logo" style="margin-right: 20px;">
				<a class="navbar-brand" id="navbarBrand" href="/dndn/main.do"> <img
					src="/dndn/resources/img/logo_edit.png" class="mt-1 mb-2"
					style="width: 40px;">
				</a>
			</div>
			<div class="navbar-menu">
				<div class="nav-item">
					<a href="#" class="nav-link">메뉴소개</a>
				</div>
				<div class="nav-item">
					<a href="#" class="nav-link">매장찾기</a>
				</div>
				<div class="nav-item">
			...
			<div class="navbar-menu" id="menu">
				...
				<div class="nav-item dropdown">
					<a href="" class="nav-link dropdown-toggle" role="button"
						data-bs-toggle="dropdown" aria-expanded="true"> 로그인 </a>
					<ul class="dropdown-menu">
						<li><div class="nav-item">
								<a href="#" class="nav-link" style="margin-left: 20px;">로그아웃</a>
							</div></li>
						<li><div class="nav-item">
								<a href="#" class="nav-link" style="margin-left: 20px;">마이페이지</a>
							</div></li>
					</ul>
				</div>
			</div>
	...
	<div id="sidebar">
		...
		<div id="side-content">
			...
			<button onclick="location.href='/dndn/mypage/.do';">LOGOUT</button>
